...
>![](http://swift.ggimg/articles/swift-2-lets-try/1.png)



___

>![](http://swift.ggimg/articles/swift-2-lets-try/2.png)

___

>![](http://swift.ggimg/articles/swift-2-lets-try/3.png)

还有一件事我没有发到推特上：我对 Swift 最大的改动——`try?`关键字——很不理解。

![](http://swift.ggimg/articles/swift-2-lets-try/Screen-Shot-2015-08-26-at-4.48.03-AM.png)
