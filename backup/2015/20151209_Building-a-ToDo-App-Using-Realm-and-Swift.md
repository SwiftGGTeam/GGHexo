...
![](https://swift.gg/img/articles/building-a-todo-app-using-realm-and-swift/realm-db-1024x683.jpg1500171566.91)
...
![](https://swift.gg/img/articles/building-a-todo-app-using-realm-and-swift/realm-podfile-1024x430.png1500171567.31)
...
![](https://swift.gg/img/articles/building-a-todo-app-using-realm-and-swift/realm-pod-folder-1024x446.png1500171567.71)
...
![](https://swift.gg/img/articles/building-a-todo-app-using-realm-and-swift/realm-package-manager-1024x334.png1500171568.06)

然后在弹出的窗口中，你可以选择安装你喜欢的插件或者文件模板，在搜索框中你可以搜索你喜欢的插件、配色。在搜索框输入「Realm」，在出现的结果中选择「RealmPlugin」，点击 `Install` 按钮

![](https://swift.gg/img/articles/building-a-todo-app-using-realm-and-swift/realm-plugin-1024x996.png1500171568.8)
...
![](https://swift.gg/img/articles/building-a-todo-app-using-realm-and-swift/browser.png1500171569.27)
...
![](https://swift.gg/img/articles/building-a-todo-app-using-realm-and-swift/realm_model.png1500171569.65)

然后选择 Swift 语言，类名我们输入 Task。会得到如下结果：

![](https://swift.gg/img/articles/building-a-todo-app-using-realm-and-swift/Task_swift.png1500171570.2)
...
![](https://swift.gg/img/articles/building-a-todo-app-using-realm-and-swift/realm-todo-list-app-1024x661.png1500171570.77)
...
![](https://swift.gg/img/articles/building-a-todo-app-using-realm-and-swift/edit-mode-576x1024.png1500171571.32)
...
![](https://swift.gg/img/articles/building-a-todo-app-using-realm-and-swift/realm-database-info-1024x675.png1500171571.72)
...
![](https://swift.gg/img/articles/building-a-todo-app-using-realm-and-swift/Simulator-Screen-Shot-Oct-24-2015-8.47.06-PM-576x1024.png1500171572.27)
